<div id="detention" class="tab-pane fade">
    <form method="POST" action="{{action('DetentionsController@store')}}">
        ...
        <div class="form-group">
            <medium-editor text="{{ $detention->detention }}" v-on:edit="editDetention" :reuse-medium-editor-instance="false"></medium-editor>
        ...
        <div class="form-group">
            ...
            <input type="twitter" class="form-control" name="twitter" value="{{ $tweets->has('detention') ? $tweets->get('detention') : ''  }}">
